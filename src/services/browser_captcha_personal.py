...
# ==================== nodriver 自动安装 ====================
from .captcha.nodriver_patches import (
    _finalize_nodriver_send_task, _patch_nodriver_browser_instance,
    _patch_nodriver_connection_instance, _patch_nodriver_runtime,
)

from .captcha.bootstrap import (
    _detect_playwright_browser_path, _ensure_nodriver_installed,
    _ensure_playwright_browser_path, _ensure_playwright_installed,
    _run_pip_install, _run_playwright_install,
)
